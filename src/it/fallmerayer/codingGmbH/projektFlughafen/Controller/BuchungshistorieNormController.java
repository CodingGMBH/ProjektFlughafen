...
public class BuchungshistorieNormController extends AbstractController {
    ...
    public void startController() {
        ...
        buchungsprofilObservableList = BuchungInformationClass.getObjektListAnwender(BuchungsprofileSpeicher.getInstance().getBuchungsprofile(main.benutzerprofil.getPID()));
